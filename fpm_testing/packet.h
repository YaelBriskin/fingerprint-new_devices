...
#define FINGERPRINT_PASSFAIL 0x13           // Узнайте, прошел ли отпечаток пальца или нет
...
#define FINGERPRINT_VERIFYPASSWORD 0x13 // Команда для проверки пароля
...
#define FINGERPRINT_HANDSHAKE 0x17       // Пример команды для рукопожатия
